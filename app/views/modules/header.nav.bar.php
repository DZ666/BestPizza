<nav class="bar close-bar">
  <div class="bar-close" id="bar-close"></div>
  <div class="bar-open" id="bar-open"><div class="line"></div></div>
  <div class="bar-links">
    <? if ($_SERVER['REQUEST_URI'] !== '/') { ?>
      <a class="link-btn" href="/">Home</a>
    <? } 
      if ($_SERVER['REQUEST_URI'] !== '/Pizza') { ?>
      <a class="link-btn" href="./Pizza">Pizza</a>
    <? }
      if ($_SERVER['REQUEST_URI'] !== '/Snacks') { ?>
      <a class="link-btn" href="./Snacks">Snacks</a>
      <? } ?>
  </div>
  <div class="bar-links-btns">
    <div class="dropdown dropdown-currency" id="select-currency">
      <label data-curr-type="EUR" id="selected-currency">€</label>
      <ul class="dropdown-content">
        <li class="select-currency-btn" data-curr-type="USD">$</li>
        <li class="select-currency-btn" data-curr-type="EUR">€</li>
      </ul>
    </div>
    <?
      if (!$_SESSION['user']['isAuthorized']) { 
        include '/app/views/modules/auth.btn.php';
      } else {
        ?>
          <a href="/auth/logout" class="auth-link log-out notranslate">Log Out</a>
        <?
      }
      if ($_SERVER['REQUEST_URI'] !== '/account' && $_SESSION['user']['isAuthorized']) {
        ?>
          <a href="/account" class="auth-link log-out notranslate">Account</a>
        <?
      }
    ?>
    <?
      if ($_SERVER['REQUEST_URI'] !== '/Basket') { 
        ?>
          <a href="/Basket" class="shop-card">
            ...
            <div id="card-amount"><?= count($_SESSION['user']['basket']) ?></div> 
          </a> 
        <?
      }
    ?>
